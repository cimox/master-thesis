...
Analýza a spracovanie prúdov dát pridáva viaceré otvorené výzvy a možnosti pre výskum \citep{krempl2014open}:  %TODO: pridat sem nejake 1-2 citacie este
\begin{itemize}
...
% TODO: mozno este rozsirit turniket
...
\paragraph{Ohraničenia} ktoré je potrebné aby spĺňali algoritmy pre dolovanie z prúdov dát (angl. data stream mining) \citep{babcock2002models, nguyen2015survey, wadewale2015survey}:
\begin{itemize}
...
%TODO: pridat nejaky test, neviem aky...
...
% TODO: tento odsek sa veducemu velmi nepacil
\par
...
% TODO: pridat tabulky s pouzitim algoritmov, vid. koment od veduceho
...
% TODO: sumar zhlukovacich algoritmov
...
% TODO: pridat gaussian naive bayes
...
% TODO: daju sa pouzit lesy na prudy dat?
...
% TODO: pridat otvoreny problem, ktory chcem riesit, pomenovat a popisat
